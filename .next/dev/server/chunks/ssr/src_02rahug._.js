...
"[project]/src/app/pendaftar/dashboard/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PendaftarDashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        (async ()=>{
            const students = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiGetStudents"])();
            const s = students.find((st)=>st.user_id === user.id);
            setStudent(s || null);
            if (s) {
                const allDocs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiGetDocuments"])();
                setDocs(allDocs.filter((d)=>d.student_id === s.id));
                const allPayments = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiGetPayments"])();
                setPayment(allPayments.find((p)=>p.student_id === s.id) || null);
            }
        })();
    }, [
        user,
...
//# sourceMappingURL=src_02rahug._.js.map