...
async function POST(req) {
    try {
        ...
        const last = await db.collection('documents').find().sort({
            id: -1
        }).limit(1).toArray();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ss7ze-._.js.map