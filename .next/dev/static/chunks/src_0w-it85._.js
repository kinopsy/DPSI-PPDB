...
async function apiUpsertDocument(studentId, fileType, filePath) {
    return fetchJSON(`${API}/documents`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
...
async function apiVerifyDocument(docId, status, note) {
    return fetchJSON(`${API}/documents`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
...
async function apiCreatePayment(studentId, proofPath) {
    return fetchJSON(`${API}/payments`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
...
async function apiVerifyPayment(paymentId, status, officer) {
    return fetchJSON(`${API}/payments`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
...
async function apiGetQuotas() {
    return fetchJSON(`${API}/quotas`);
}
async function apiUpdateQuota(id, data) {
    return fetchJSON(`${API}/quotas`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
...
async function apiGetTariffs() {
    return fetchJSON(`${API}/tariffs`);
}
async function apiCreateTariff(data) {
    return fetchJSON(`${API}/tariffs`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
...
async function apiUpdateTariff(id, data) {
    return fetchJSON(`${API}/tariffs`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
...
async function apiDeleteTariff(id) {
    return fetchJSON(`${API}/tariffs?id=${id}`, {
        method: 'DELETE'
    });
}
async function apiGetAnnouncements() {
    return fetchJSON(`${API}/announcements`);
}
async function apiCreateAnnouncement(title, content) {
    return fetchJSON(`${API}/announcements`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
...
function getStoredUser() {
    ...
    ;
    try {
        const stored = localStorage.getItem('ppdb_user');
...
_s(AuthProvider, "52zsbfL0enoGlZIB37NDdfhb6Rk=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
const NAV_ITEMS = {
    pendaftar: [
        {
            label: 'Dashboard',
            href: '/pendaftar/dashboard',
            icon: '🏠'
        },
        {
            label: 'Biodata',
            href: '/pendaftar/biodata',
            icon: '👤'
        },
        {
            label: 'Dokumen',
    ...
    panitia: [
        ...
        },
        {
            ...
            href: '/panitia/verifikasi-berkas',
            icon: '✅'
        },
        {
            label: 'Kuota Dinamis',
            href: '/panitia/kuota-dinamis',
            icon: '📋'
        },
        {
            label: 'Kelulusan',
            href: '/panitia/kelulusan',
            icon: '🎓'
        },
        {
            label: 'Buat Pengumuman',
            href: '/panitia/pengumuman',
            icon: '✍️'
        }
    ],
    bendahara: [
        ...
        },
        {
            ...
            href: '/bendahara/verifikasi-pembayaran',
            icon: '💳'
        },
        {
            label: 'Tarif Biaya',
            href: '/bendahara/tarif-biaya',
            icon: '💲'
        },
        {
            label: 'Audit Log',
            href: '/bendahara/audit-log',
            icon: '📝'
        }
    ],
    kepsek: [
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                src: "/logo.png",
                                                alt: "Logo",
                                                className: "w-10 h-10 rounded-xl object-contain bg-white p-0.5 shadow-lg shadow-[#1D20DA]/30"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/Sidebar.tsx",
                                                lineNumber: 59,
                                                columnNumber: 15
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: "SD Muhammadiyah Karangkajen"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/Sidebar.tsx",
                                                        lineNumber: 61,
                                                        columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: onClose,
                                        className: "md:hidden p-1.5 hover:bg-white/10 rounded-lg transition-colors text-white/40 hover:text-white/80",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "inline-block bg-white/10 text-white/60 text-[11px] font-semibold px-2.5 py-1 rounded-md uppercase tracking-wider",
                                children: user.role
                            }, void 0, false, {
                                fileName: "[project]/src/components/Sidebar.tsx",
                                lineNumber: 69,
                    ...
                    visibleBottomLinks.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "px-3 pb-1",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "border-t border-white/5 pt-2 mt-1",
                            children: visibleBottomLinks.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    href: item.href,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "w-9 h-9 rounded-full bg-gradient-to-br from-[#1D20DA] to-[#4B50E8] flex items-center justify-center text-sm font-bold shrink-0",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                                                d: "M5.25 12.75h-3a.75.75 0 01-.75-.75V3a.75.75 0 01.75-.75h3m4.5-1.5H15a.75.75 0 01.75.75v9a.75.75 0 01-.75.75h-5.25m-4.5 0V3h4.5v8.25"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/Sidebar.tsx",
                                                lineNumber: 117,
                                                columnNumber: 93
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                                                d: "M9.75 7.5l3-3m0 0l3 3m-3-3v7.5"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/Sidebar.tsx",
                                                lineNumber: 117,
                                                columnNumber: 237
...
_s(Sidebar, "N1dsTcvWwtwJPJ9IevL1KpGIvrI=", false, function() {
    return [
...
function DashboardLayout({ children }) {
    ...
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "w-10 h-10 border-[3px] border-deep-blue border-t-transparent rounded-full animate-spin"
                    }, void 0, false, {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex-1 md:ml-[260px]",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                        className: "bg-white border-b border-slate-200/60 px-4 h-14 flex items-center md:hidden sticky top-0 z-20",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "text-base font-bold text-slate-800 ml-2",
                                children: "SD Muhammadiyah Karangkajen"
                            }, void 0, false, {
                                fileName: "[project]/src/components/DashboardLayout.tsx",
                                lineNumber: 35,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                        className: "hidden md:flex bg-white border-b border-slate-200/60 px-8 h-16 items-center justify-between sticky top-0 z-20",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(DashboardLayout, "6HeWbh66OtHCpaQYQIfiL3qPDUs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=src_0w-it85._.js.map